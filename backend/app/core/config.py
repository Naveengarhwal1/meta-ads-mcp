...
class Settings(BaseSettings):
    ...
    meta_app_id: str = "665587869862344"
    meta_app_secret: str = "2eebb6109153f476f9df8625d673917e"
    ...
    # Meta Ads API
    meta_app_id_legacy: Optional[str] = None
    meta_app_secret_legacy: Optional[str] = None
